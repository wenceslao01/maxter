...
class City extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_state, name', 'required'),
			array('id_state', 'length', 'max'=>11),
	...
	public function relations()
	{
		...
		return array(
			'administrators' => array(self::HAS_MANY, 'Administrator', 'id_city'),
			'idState' => array(self::BELONGS_TO, 'State', 'id_state'),
			'clients' => array(self::HAS_MANY, 'Client', 'id_city'),
			'engineers' => array(self::HAS_MANY, 'Engineer', 'id_city'),
